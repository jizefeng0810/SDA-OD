...
class Debugger(object):
  def __init__(self, ipynb=False, theme='black', 
    ...
    elif num_classes == 8 or dataset == 'cityscapes':
        self.names = cityscapes_class_name
    elif num_classes == 8 or dataset == 'foggy_cityscapes':
        self.names = foggy_cityscapes_class_name
    elif num_classes == 8 or dataset == 'fake_cityscapes':
        self.names = fake_cityscapes_class_name
    elif num_classes ==1 or dataset == 'kitti_2d':
        self.names = kitti2d_class_name
    elif num_classes == 1 or dataset == 'fake_kitti_2d':
        self.names = fake_kitti2d_class_name
    elif num_classes == 1 or dataset == 'cityscapes_car_only':
        self.names = cityscapes_car_only_class_name
    elif num_classes == 10 or dataset == 'bdd_daytime':
      self.names = bdd_daytime_class_name
    elif num_classes == 10 or dataset == 'bdd_night':
  ...
  def save_all_imgs(self, path='./cache/debug/', prefix='', genID=False):
    ...
    for i, v in self.imgs.items():
      cv2.imwrite(path + '/{}'.format(prefix), v)
...
cityscapes_class_name = ['person', 'rider', 'car', 'truck', 'bus', 'train', 'motorcycle','bicycle']
fake_cityscapes_class_name = ['person', 'rider', 'car', 'truck', 'bus', 'train', 'motorcycle','bicycle']
foggy_cityscapes_class_name = ['person', 'rider', 'car', 'truck', 'bus', 'train', 'motorcycle','bicycle']
