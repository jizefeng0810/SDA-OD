...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--da_weight', type=float, default=10,
                             help='loss weight for domain adaptation.')
    self.parser.add_argument('--grl_weight', type=float, default=0.002,
                             help='grl weight for domain adaptation.')
  ...
  def init(self, args=''):
    default_dataset_info = {
            # cityscapes    """F:/JZF/dataset/cityscapes_data/coco_cityscapes/images"""
        ...
        #           'mean': [0.28805044, 0.32632137, 0.2854135], 'std': [0.17725339, 0.18182704, 0.17837277],
        #           'dataset': 'cityscapes_car_only'},
            # kitti_2d  """F:/JZF/dataset/kitti_data/coco_kitti/images"""
        # 'ctdet': {'default_resolution': [512, 512], 'num_classes': 1,
        #           'mean': [0.36797291, 0.38729607, 0.37598978], 'std': [0.30894696, 0.31423658, 0.31842959],
        #           'dataset': 'kitti_2d'},
            # bdd_daytime  """F:/JZF/dataset/bdd_data/bdd_daytime_city/images"""
