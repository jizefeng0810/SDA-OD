...
class Cityscapes_CarOnly(data.Dataset):
    ...
    def __init__(self, opt, split):
        super(Cityscapes_CarOnly, self).__init__()
        ...
        if split == 'val':
            self.annot_path = os.path.join(
                ...
                'instancesonly_filtered_car_only_gtFine_val.json')           # check
        elif split == 'test':
            self.annot_path = os.path.join(
                self.data_dir, 'annotations',
                'instancesonly_filtered_car_only_gtFine_val.json')           # check
            ...
            if opt.task == 'exdet':
                self.annot_path = os.path.join(
                    self.data_dir, 'annotations',
                    'instancesonly_filtered_car_only_gtFine_train.json')     # check
            else:
                self.annot_path = os.path.join(
                    self.data_dir, 'annotations',
                    'instancesonly_filtered_car_only_gtFine_train.json')     # check
        ...
        print('==> initializing coco_cityscapes_car_only {} data.'.format(split))
